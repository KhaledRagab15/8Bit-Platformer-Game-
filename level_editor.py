...
img5 = pygame.transform.scale(enemy_img, (30, 33))

door_img = pygame.image.load('images/door.png')
spike = pygame.image.load("images/spike.png")
img6 = pygame.transform.scale(spike, (tile_size, tile_size // 2))
...
save_img = pygame.image.load('images/save button.png')
img7 = pygame.transform.scale(save_img, (80,30))
load_img = pygame.image.load('images/load button.png')
img8 = pygame.transform.scale(load_img, (80,30))
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 3:
					#enemy blocks
					img = pygame.transform.scale(img5, (tile_size, int(tile_size * 0.75)))
				...
				if world_data[row][col] == 6:
					#lava
					img = pygame.transform.scale(img6, (tile_size, tile_size // 2))
...
save_button = Button(screen_width // 2 + 70, screen_height - 70, img7)
load_button = Button(screen_width // 2 + 170, screen_height - 70, img8)
